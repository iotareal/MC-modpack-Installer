...
def getModsBulk(modids):
    url = url = "https://api.modrinth.com/v2/projects"
    params = {
...
def searchProjects(query:str,selected_pack)-> list[dict]:
    ...
    return __searchMods(query,version,loader)+__searchShaders(query,version,loader)+__searchResourcepacks(query,version,loader)
